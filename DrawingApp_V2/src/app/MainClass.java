...
public class MainClass extends JFrame {
    ...
    JLabel exitLegend = new JLabel("Exit");
    JLabel stairsLegend = new JLabel("Stairs");
    JLabel elevatorLegend = new JLabel("Elevator");
    JLabel amphitheatreLegend = new JLabel("Amphitheatre");
    JLabel officeLegend = new JLabel("Administration Office");
    JLabel classroomLegend = new JLabel("Classroom");
    JLabel unidentifiedNodeLegend = new JLabel("Unidentified node");
...
//    private Node firstNode=null;
    ...
    MainClass(){
         ...
         */
        nodeEditorPanel.setLayout(new GridLayout(30,1));
        ...
        nodeEditorPanel.add(stairsLegend);
        elevatorLegend.setForeground(Color.cyan);
        nodeEditorPanel.add(elevatorLegend);
        amphitheatreLegend.setForeground(Color.orange);
        nodeEditorPanel.add(amphitheatreLegend);
        officeLegend.setForeground(Color.magenta);
        nodeEditorPanel.add(officeLegend);
        classroomLegend.setForeground(Color.red);
        nodeEditorPanel.add(classroomLegend);
        unidentifiedNodeLegend.setForeground(Color.gray);
        nodeEditorPanel.add(unidentifiedNodeLegend);
        /**
